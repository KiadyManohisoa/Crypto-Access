...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="${pageContext.request.contextPath}/web/assets/img/logo.png" alt="">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="${pageContext.request.contextPath}/web/pages/accueil/portefeuille.jsp">
      ...
      <li class="nav-item">
        <a class="nav-link " href="${pageContext.request.contextPath}/web/pages/accueil/cours.jsp">
      ...
      <li class="nav-item">
        <a class="nav-link " href="${pageContext.request.contextPath}/web/pages/accueil/vente.jsp">
          <i class="bi bi-gem"></i>
          <span>Vente</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="../utilisateur/connection.jsp">
